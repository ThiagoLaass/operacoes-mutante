...
describe('Suíte de Testes Fraca para 50 Operações Aritméticas', () => {
  ...
  test('6.0 deve calcular a raiz quadrada de zero', () => { expect(raizQuadrada(0)).toBe(0); });
  test('6.1 deve lançar erro ao calcular a raiz quadrada de número negativo', () => {
  ...
  test('8. deve calcular o fatorial de 0 e 1', () => {
    expect(fatorial(0)).toBe(1);
    expect(fatorial(1)).toBe(1);
  });
  test('8.2 deve calcular o fatorial de um número maior que 1', () => { expect(fatorial(4)).toBe(24); });
  test('8.1 deve lançar erro para fatorial de número negativo', () => {
  ...
  test('9.1 deve retornar zero para a média de um array vazio', () => { expect(mediaArray([])).toBe(0); });
  ...
  test('11.1 deve lançar erro para array vazio ao buscar o máximo', () => {
  ...
  test('12.1 deve lançar erro para array vazio ao buscar o mínimo', () => {
  ...
  test('15.1 deve retornar false para um número ímpar ao verificar paridade', () => { expect(isPar(3)).toBe(false); });
  test('16. deve retornar true para um número ímpar', () => { expect(isImpar(7)).toBe(true); });
  test('16.1 deve retornar false para um número par ao verificar imparidade', () => { expect(isImpar(4)).toBe(false); });
  ...
  test('33.1 deve retornar false para 0, 1 e números compostos', () => {
  ...
  test('35.1 deve retornar 1 para o produto de um array vazio', () => { expect(produtoArray([])).toBe(1); });
  test('36. deve manter um valor dentro de um intervalo (clamp)', () => { expect(clamp(5, 0, 10)).toBe(5); });
  test('36.1 deve limitar valores abaixo e acima do intervalo', () => {
  ...
  test('37.1 deve retornar false quando um número não é divisível por outro', () => { expect(isDivisivel(10, 3)).toBe(false); });
  test('38. deve converter Celsius para Fahrenheit', () => { expect(celsiusParaFahrenheit(100)).toBe(212); });
  test('39. deve converter Fahrenheit para Celsius', () => { expect(fahrenheitParaCelsius(212)).toBe(100); });
  test('40. deve calcular o inverso de um número', () => { expect(inverso(4)).toBe(0.25); });
  test('40.1 deve lançar erro ao calcular o inverso de zero', () => {
  ...
  test('44.1 deve retornar false quando o primeiro número não é maior', () => {
  ...
  test('45.1 deve retornar false quando o primeiro número não é menor', () => {
  ...
  test('46.1 deve retornar false para números diferentes', () => { expect(isEqual(7, 8)).toBe(false); });
  test('47. deve calcular a mediana de um array ímpar e ordenado', () => { expect(medianaArray([1, 2, 3, 4, 5])).toBe(3); });
  test('47.1 deve calcular a mediana de arrays ímpares e pares desordenados', () => {
    expect(medianaArray([10, 1, 2])).toBe(2);
    expect(medianaArray([40, 1, 2, 3, 4, 100])).toBe(3.5);
  });
  test('47.2 deve lançar erro para array vazio ao calcular a mediana', () => {
